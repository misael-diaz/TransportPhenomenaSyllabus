...
\begin{itemize}
    ...
    \item \textbf{Applied Tooling:} Either MATLAB or the Scientific Python Ecosystem. Generating 2D Cartesian plots (spatial profiles and temporal evolution) and technical execution of \textbf{Contour Plots} to visualize 2D scalar fields $C(x,y)$ and $T(x,y)$.
\end{itemize}

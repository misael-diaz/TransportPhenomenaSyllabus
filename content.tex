...
\begin{itemize}
    ...
    \item \textbf{Resolve} linear partial differential equations (PDEs) analytically for steady and transient transport states in 1D and 2D geometries using separation of variables, similarity techniques, and integral transforms.
